...
const Social = ({ form, authentication, requests, editProfile }) => {
            ...
            <div className="px-4 pt-4">
              <Row type="flex" align="top" justify="space-between">
                <Col>
                  ...
                  <p className="mb-0" style={{textTransform: "capitalize"}}>{usertype}</p>
                  <a
                    href="javascript:;"
                    css={`
                      display: block;
                ...
                <Col>
                  <div className="text-center">
                    <Avatar size={80} src={picture !== "" ? picture : "/static/images/avatar.jpg"} />
        ...
        >
          ...
          {activeTab === '4' && (
            <Card>
              ...
              <Uploader uploadResponse={(data) => {if(data.picture) return editProf({picture: data.picture}, _id)}} />
              <hr />
              <Form onSubmit={(e) => {
							e.preventDefault();
